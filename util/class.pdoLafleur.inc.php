...
*/
	...
	public function modifierProduit($id, $description, $prix, $image, $oldId)
	{
		$req="UPDATE produit SET id = '$id', description = '$description', prix = '$prix', image = '$image' where id = '$oldId'";
		$res = PdoLafleur::$monPdo->exec($req);
	}
	
	public function creeProduit($id, $description, $prix, $image, $categorie)
	{
		$req="insert into produit values ('$id','$description','$prix','$image','$categorie')";
		$res = PdoLafleur::$monPdo->exec($req);
	}
	...
	public function validco($user,$mdp)
	{
